...
// /**
//  * XSML language participant contribution.
//  */
// interface LanguageParticipantContribution {
// 	/**
// 	 * The id of the language which participates with the XSML language server.
// 	 */
// 	languageId: string;
// 	/**
...
export function getLanguageParticipants(): LanguageParticipants {
	...
	function update() {
		...
		// No need to participate in other languages
