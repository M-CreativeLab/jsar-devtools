...
export const cssData: CSSDataV1 = {
  ...
  "properties": [
    ...
    // Spatial CSS Properties
    {
      "name": "rotation",
      "syntax": "[<angle>]{1,3}",
      "values": [],
      "relevance": 50,
      "description": "Defines a rotation transformation in angle(x,y,z)."
    },
    {
      "name": "position",
      "syntax": "[<length>]{1,3}",
      "values": [],
      "relevance": 50,
      "description": "Defines a position transformation in position(x,y,z)."
    },
    {
      "name": "scaling",
      "syntax": "[<length>]{1,3}",
      "values": [],
      "relevance": 50,
      "description": "Defines a scaling transformation in scale(x,y,z)."
    },
    {
      "name": "x",
      "syntax": "<length>",
      "values": [],
      "relevance": 50,
      "description": "Defines a x-axis transformation in translate(x)."
    },
    {
      "name": "y",
      "syntax": "<length>",
      "values": [],
      "relevance": 50,
      "description": "Defines a y-axis transformation in translate(y)."
    },
    {
      "name": "z",
      "syntax": "<length>",
      "values": [],
      "relevance": 50,
      "description": "Defines a z-axis transformation in translate(z)."
    },
    {
      "name": "material",
      "syntax": "<material-name>",
      "values": [],
      "relevance": 50,
      "description": "Defines the material of an element."
    },
    {
      "name": "diffuse-color",
      "syntax": "<color>",
      ...
      "atRule": "@material",
      "references": [],
      "description": "Defines the diffuse color of a material."
    },
    {
      ...
      "atRule": "@material",
      "references": [],
      "description": "Defines whether the back face of an element should be visible when turned away from the viewer."
    },
