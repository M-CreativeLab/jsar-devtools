 ...
 *--------------------------------------------------------------------------------------------*/
// Maintained by JSAR working group.
  ...
  "tags": [
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The xsml element represents the root of a XSML document."
      },
      "attributes": [
        {
          "name": "manifest",
      ...
      "references": [
        {
          "name": "XSML Documentation",
          "url": "https://jsar.netlify.app/manual/latest/basic-concepts/intro-xsml"
        }
      ]
    },
    {
    ...
    },
    {
      ...
      "attributes": [
        ...
        },
        {
          ...
          "description": {
            "kind": "markdown",
            "value": "This attribute defines the styling language as a MIME type (charset should not be specified). This attribute must be present and to be `text/scss`",
          },
          "values": [
            {
              "name": "text/scss"
      ...
      "references": [
        {
          ...
          "url": "https://jsar.netlify.app/manual/latest/basic-concepts/intro-scss"
        }
      ]
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The space element represents the content of this space."
      },
      "attributes": [
        // {
        // 	"name": "onafterprint",
    ...
    // }
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The mesh element represents a set of 3D vertices (points) from a loaded model such as a .glb file."
      },
      "attributes": [
        {
          "name": "ref",
          "description": {
            "kind": "markdown",
            "value": "The `ref` attribute is a unique identifier for the mesh. It is used to reference a model from the <link> elements."
          }
        },
        {
          "name": "selector",
          "description": {
            "kind": "markdown",
            "value": "The `selector` attribute is a string that is used to select a subset of the mesh nodes. Use __root__ to select the root node of the model."
          }
        }
      ],
      "references": []
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The cube element represents a 3D cube."
      },
      "attributes": [
        {
          "name": "width",
          "description": {
            "kind": "markdown",
            "value": "The `width` attribute specifies the width of the cube.",
          }
        },
        {
          "name": "height",
          "description": {
            "kind": "markdown",
            "value": "The `height` attribute specifies the height of the cube.",
          }
        },
        {
          "name": "depth",
          "description": {
            "kind": "markdown",
            "value": "The `depth` attribute specifies the depth of the cube.",
          }
        },
        {
          "name": "size",
          "description": {
            "kind": "markdown",
            "value": "The `size` attribute specifies the size of the cube, which will be overridden by the `width`, `height` and `depth` attributes if they are present.",
          }
        }
      ],
      "references": []
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The plane element represents a plane in this space."
      },
      "attributes": [
        {
          "name": "width",
          "description": {
            "kind": "markdown",
            "value": "The `width` attribute specifies the width of the plane.",
          }
        },
        {
          "name": "height",
          "description": {
            "kind": "markdown",
            "value": "The `height` attribute specifies the height of the plane.",
          }
        },
        {
          "name": "size",
          "description": {
            "kind": "markdown",
            "value": "The `size` attribute specifies the size of the plane, which will be overridden by the `width` and `height` attributes if they are present.",
          }
        }
      ]
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The sphere element represents a sphere in this space."
      },
      "attributes": [
        {
          "name": "segments",
          "description": {
            "kind": "markdown",
            "value": "The `segments` attribute specifies the number of segments in the sphere."
          }
        },
        {
          "name": "diameter",
          "description": {
            "kind": "markdown",
            "value": "The `diameter` attribute specifies the diameter of the sphere."
          }
        },
        {
          "name": "diameter-x",
          "description": {
            "kind": "markdown",
            "value": "The `diameter-x` attribute specifies the diameter of the sphere along the X axis."
          }
        },
        {
          "name": "diameter-y",
          "description": {
            "kind": "markdown",
            "value": "The `diameter-y` attribute specifies the diameter of the sphere along the Y axis."
          }
        },
        {
          "name": "diameter-z",
          "description": {
            "kind": "markdown",
            "value": "The `diameter-z` attribute specifies the diameter of the sphere along the Z axis."
          }
        },
        {
          "name": "arc",
          "description": {
            "kind": "markdown",
            "value": "The `arc` attribute specifies the arc of the sphere, its value type is a number."
          }
        },
        {
          "name": "slice",
          "description": {
            "kind": "markdown",
            "value": "The `slice` attribute specifies the slice number of the sphere."
          }
        }
      ]
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The cylinder element represents a cylinder in this space."
      },
      "attributes": [
        {
          "name": "height",
        ...
        {
          "name": "diameter",
          "description": "The diameter number of the cylinder."
        },
        {
          "name": "diameter-top",
          "description": "The top diameter number of the cylinder."
        },
        {
          "name": "diameter-bottom",
          "description": "The bottom diameter number of the cylinder."
        }
      ]
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The capsule element represents a capsule in this space."
      },
      "attributes": [
        {
          "name": "height",
        ...
        {
          "name": "radius",
          "description": "The radius number of the capsule."
        },
        {
          "name": "radius-top",
          "description": "The top radius number of the capsule."
        },
        {
          "name": "radius-bottom",
          "description": "The bottom radius number of the capsule."
        }
      ]
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The torus element represents a torus in this space."
      },
      "attributes": [
        {
          "name": "diameter",
          "description": "The diameter number of the torus object."
        },
        {
          "name": "thickness",
          "description": "The number to describe how the torus thick is."
        },
        {
          "name": "tessellation",
          "description": "The number to describe segments of the torus."
        }
      ]
    },
    {
      ...
      "description": {
        "kind": "markdown",
        "value": "The bound element represents a bounding box in this space."
      },
      "attributes": []
    }
  ],
